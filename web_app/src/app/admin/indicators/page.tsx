  ...
  if (accessLoading) {
    return (
      <div className="flex h-screen items-center justify-center bg-slate-900 text-white">
        <RubikLoader label="Rubik is verifying access…" />
      </div>
    );
  }
      ...
      <div className="max-w-5xl mx-auto space-y-6">
        <header className="flex items-start justify-between border-b border-slate-800 pb-4 gap-4">
          <div className="space-y-1">
            ...
            <h1 className="text-2xl font-bold">Signal Configuration</h1>
            ...
            <Button
              ...
              onClick={async () => {
                ...
                try {
                  ...
                  setMessage({ type: "error", text: "Unable to enable selected indicators." });
                } finally {
            ...
            <Button
              ...
              onClick={async () => {
                ...
                try {
                  ...
                  setMessage({ type: "error", text: "Unable to disable selected indicators." });
                } finally {
                  setBulkUpdating(false);
                }
              }}
                  ...
                  <tr key={row.id} className="hover:bg-slate-900/60">
                    ...
                    <td className="px-3 py-2">
                      <Input
                        ...
                        onChange={(e) => updateField(row.id, "indicator_name", e.target.value)}
                    ...
                    <td className="px-3 py-2">
                      <Input
                        ...
                        onBlur={(e) => updateField(row.id, "description", e.target.value)}
                    ...
                    <td className="px-3 py-2">
                      <Input
                        ...
                        onBlur={(e) => updateField(row.id, "parameter_1", parseNumber(e.target.value))}
                        className="h-7 bg-slate-900/70 border-slate-800 text-[11px]"
                      />
                    </td>
                    <td className="px-3 py-2">
                      <Input
                        ...
                        onBlur={(e) => updateField(row.id, "parameter_2", parseNumber(e.target.value))}
                        className="h-7 bg-slate-900/70 border-slate-800 text-[11px]"
                      />
                    </td>
                    <td className="px-3 py-2">
                      <Input
                        ...
                        onBlur={(e) => updateField(row.id, "parameter_3", parseNumber(e.target.value))}
                        className="h-7 bg-slate-900/70 border-slate-800 text-[11px]"
                      />
                    </td>
                    <td className="px-3 py-2">
                      <Input
                        ...
                        onBlur={(e) => updateField(row.id, "manual_weight", parseNumber(e.target.value))}
                        className="h-7 bg-slate-900/70 border-slate-800 text-[11px]"
                      />
                    </td>
                    <td className="px-3 py-2">
                    ...
                    <td className="px-3 py-2">
                      <Input
                        ...
                        onBlur={(e) => updateField(row.id, "ai_latest_weight", parseNumber(e.target.value))}
                        className="h-7 bg-slate-900/70 border-slate-800 text-[11px]"
                      />
                    </td>
                    <td className="px-3 py-2">
        ...
        <div className="text-[11px] text-slate-500">
          <p>When you run the Signals job in the Admin console, it uses this table instead of Excel to decide which indicators to calculate.</p>
        </div>
      </div>
    </div>
  );
